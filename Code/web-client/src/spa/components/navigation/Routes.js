    ...
    return (
        <>
            ...
            <Switch>
                ...
                <Route exact path="/createQuestionnaire" component={CreateEditQuestionnaire} />
                <Route exact path="/editQuestionnaire/:questionnaireId" component={CreateEditQuestionnaire} />
